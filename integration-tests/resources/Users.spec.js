...
describe('Ingest API : Resource : Users', function () {
  ...
  describe('unlinkUser', function () {
    ...
    it('Should successfully unlink a user from the authorized network.', function (done) {
      ...
      // Mock the response from the REST API.
      mock.mock('UNLINK', api.config.host + '/users/some-user-id',
        function (request, response) {
      ...
      request = usersResource.unlinkUser(id).then(function (response) {
    ...
    it('Should fail if no "id" is passed in.', function (done) {
      ...
      usersResource.unlinkUser(null).then(function (response) {
  ...
  describe('linkUser', function () {
    ...
    it('Should successfully link a user to the authorized network.', function (done) {
      ...
      // Mock the response from the REST API.
      mock.mock('LINK', api.config.host + '/users/some-new-user-id',
        function (request, response) {
      ...
      request = usersResource.linkUser(id).then(function (response) {
    ...
    it('Should fail if no "id" is passed in.', function (done) {
      ...
      usersResource.linkUser(null).then(function (response) {
